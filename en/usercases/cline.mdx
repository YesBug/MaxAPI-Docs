---
title: "Cline"
description: "Use MaxAPI for agentic coding tasks in VS Code."
---

[Cline](https://github.com/cline/cline) supports custom OpenAI-compatible model providers.

<Steps>
  <Step title="Install and open settings">
    Install Cline, then open its model or provider settings.
  </Step>

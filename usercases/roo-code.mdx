---
title: "Roo Code"
description: "在 Roo Code 的 Code、Architect、Ask 和 Debug 模式中使用 MaxAPI。"
---

[Roo Code](https://github.com/RooVetGit/Roo-Code) 支持自定义 OpenAI 兼容模型供应商。

<Steps>
  <Step title="安装并打开设置">
    安装 Roo Code，然后打开模型或供应商设置。
  </Step>
